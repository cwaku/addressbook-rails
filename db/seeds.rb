...
a = User.create!(firstname: "Ricky", lastname: "Mormor", email: "ricky@appsnmobilesolutions.com", password: "123456", password_confirmation: "123456")
if a.save
UserRole.create!(user_id: a.id, role_code: 'SA', active_status: true, del_status: false)
end
