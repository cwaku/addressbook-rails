...
class UserRolesControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create user_role' do
    assert_difference('UserRole.count') do
      post user_roles_url,
           params: { user_role: { active_status: @user_role.active_status, created_at: @user_role.created_at,
                                  del_status: @user_role.del_status, role_code: @user_role.role_code, updated_at: @user_role.updated_at, user_id: @user_role.user_id } }
    end
