...
class UserRolesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_role" do
    assert_difference("UserRole.count") do
      post user_roles_url, params: { user_role: { active_status: @user_role.active_status, del_status: @user_role.del_status, role_code: @user_role.role_code, user_id: @user_role.user_id } }
    end
  ...
  test "should update user_role" do
    patch user_role_url(@user_role), params: { user_role: { active_status: @user_role.active_status, del_status: @user_role.del_status, role_code: @user_role.role_code, user_id: @user_role.user_id } }
