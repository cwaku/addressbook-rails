  ...
  test 'should create permissions_role' do
    assert_difference('PermissionsRole.count') do
      post permissions_roles_url,
           params: { permissions_role: { created_at: @permissions_role.created_at, permission_id: @permissions_role.permission_id,
                                         role_code: @permissions_role.role_code, role_id: @permissions_role.role_id, updated_at: @permissions_role.updated_at } }
    end
