...
class PermissionsRolesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create permissions_role" do
    assert_difference("PermissionsRole.count") do
      post permissions_roles_url, params: { permissions_role: { permission_id: @permissions_role.permission_id, role_code: @permissions_role.role_code, role_id: @permissions_role.role_id } }
    end
  ...
  test "should update permissions_role" do
    patch permissions_role_url(@permissions_role), params: { permissions_role: { permission_id: @permissions_role.permission_id, role_code: @permissions_role.role_code, role_id: @permissions_role.role_id } }
