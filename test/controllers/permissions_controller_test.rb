...
class PermissionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create permission" do
    assert_difference("Permission.count") do
      post permissions_url, params: { permission: { action: @permission.action, description: @permission.description, name: @permission.name, subject_class: @permission.subject_class } }
    end
  ...
  test "should update permission" do
    patch permission_url(@permission), params: { permission: { action: @permission.action, description: @permission.description, name: @permission.name, subject_class: @permission.subject_class } }
