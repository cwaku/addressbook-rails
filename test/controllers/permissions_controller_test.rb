  ...
  test 'should create permission' do
    assert_difference('Permission.count') do
      post permissions_url,
           params: { permission: { action: @permission.action, created_at: @permission.created_at,
                                   description: @permission.description, name: @permission.name, subject_class: @permission.subject_class, updated_at: @permission.updated_at } }
    end
