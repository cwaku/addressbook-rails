...
class SuburbsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create suburb" do
    assert_difference("Suburb.count") do
      post suburbs_url, params: { suburb: { city_id: @suburb.city_id, name: @suburb.name, remarks: @suburb.remarks, user_id: @suburb.user_id } }
    end
  ...
  test "should update suburb" do
    patch suburb_url(@suburb), params: { suburb: { city_id: @suburb.city_id, name: @suburb.name, remarks: @suburb.remarks, user_id: @suburb.user_id } }
